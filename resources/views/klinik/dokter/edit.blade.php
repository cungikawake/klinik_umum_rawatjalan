	...
	<div class="row"> 
		<div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="card card-stats">
              	<form class="form-horizontal" role="form" method="POST" action="{{ url('dokter/edit_register') }}">
                        {{ csrf_field() }}

                     <input id="id_user" type="hidden" class="form-control" name="id_user" value="{{old('id_user',$user->id)}}" required >

                     <input id="id_dokter" type="hidden" class="form-control" name="id_dokter" value="{{old('id_dokter',$row->id_dokter)}}" required >
	              	...
	              	<div class="card-body ">
	                    ...
	                    <div class="form-group">
	                        ...
	                        <div class="col-md-6">
	                        	<input type="date" name="tgl_lahir" class="form-control{{ $errors->has('tgl_lahir') ? ' has-error' : '' }}" value="{{ old('tgl_lahir', $row->tgl_lahir) }}" required>
	                    ...
	                    <div class="form-group">
	                        <label for="password" class="col-md-4 control-label">Gelar</label>

	                        <div class="col-md-6">
	                        	<input type="text" name="gelar" class="form-control{{ $errors->has('gelar') ? ' has-error' : '' }}" value="{{ old('gelar', $row->gelar) }}" required>
