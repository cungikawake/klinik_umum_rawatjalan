	...
	<div class="row"> 
		<div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="card card-stats">
              	<form class="form-horizontal" role="form" method="POST" action="{{ url('dokter/do_register') }}">
                        {{ csrf_field() }}
	              	...
	              	<div class="card-body ">
	                    ...
	                    <div class="form-group">
	                        ...
	                        <div class="col-md-6">
	                        	<input type="date" name="tgl_lahir" class="form-control{{ $errors->has('tgl_lahir') ? ' has-error' : '' }}">
	                    ...
	                    <div class="form-group">
	                        ...
	                        <div class="col-md-6">
	                        	<input type="text" name="gelar" class="form-control{{ $errors->has('gelar') ? ' has-error' : '' }}">
