	...
	<div class="row"> 
		<div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="card card-stats">
              	<form class="form-horizontal" role="form" method="POST" action="{{ url('kasir/edit_register') }}">
                        {{ csrf_field() }}

                     <input id="id_user" type="hidden" class="form-control" name="id_user" value="{{old('id_user',$user->id)}}" required >

                     <input id="id_kasir" type="hidden" class="form-control" name="id_kasir" value="{{old('id_kasir',$row->id_kasir)}}" required >
