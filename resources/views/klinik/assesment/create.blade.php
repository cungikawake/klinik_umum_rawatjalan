...
<div class="col-lg-12 col-md-12 lf_topics_wrapper"> 
  <h3>Assesment | Assesment Baru</h3>
	<div class="row"> 
              	...
              	<form class="form-horizontal" role="form" method="POST" action="{{ url('assesment/do_create') }}">
	              	...
	              	<div class="card-body ">
	                    ...
	                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
	                        <label for="name" class="col-md-3 control-label">Cari Pasien</label>

	                        <div class="col-md-6">
	                            <input id="query" type="text" class="form-control" name="query" value="{{ old('query', (isset($pasien_arr->no_rm))? $pasien_arr->no_rm: '') }}" autofocus placeholder="Cari No RM"> 
	                        </div>
	                        <div class="col-md-3">
	                            <button type="button" id="search_pasien" class="btn btn-danger" style="margin-top: -5px;">Cari</button> 
	                        </div>
	                    </div> 
              		...
              		<hr>
              			...
              			<div class="col-md-6">
              				<div class="form-group {{ $errors->has('keluhan') ? ' has-error' : '' }}"> 
		                        ...
		                        <input id="keluhan" type="text" class="form-control" name="keluhan" value="{{ old('keluhan') }}" autofocus> 
		                    </div>
		                    <div class="form-group {{ $errors->has('riwayat_keluhan') ? ' has-error' : '' }}"> 
		                        <label for="name" class="control-label">Riwayat Keluhan</label>
		                        <input id="riwayat_keluhan" type="text" class="form-control" name="riwayat_keluhan" value="{{ old('riwayat_keluhan') }}" autofocus> 
		                    </div>
		                    ...
		                    <div class="form-group {{ $errors->has('inspeksi_dinamis') ? ' has-error' : '' }}"> 
		                        ...
		                        <input id="inspeksi_dinamis" type="text" class="form-control" name="inspeksi_dinamis" value="{{ old('inspeksi_dinamis') }}" autofocus> 
		                    </div>
		                    <div class="form-group {{ $errors->has('keterbatasan_gerakan') ? ' has-error' : '' }}"> 
		                        ...
		                        <input id="keterbatasan_gerakan" type="text" class="form-control" name="keterbatasan_gerakan" value="{{ old('keterbatasan_gerakan') }}" autofocus> 
		                    </div>
		                    <div class="form-group {{ $errors->has('tissue_impairment') ? ' has-error' : '' }}"> 
		                        <label for="name" class="control-label">Tissue Impairment</label>
		                        <input id="tissue_impairment" type="text" class="form-control" name="tissue_impairment" value="{{ old('tissue_impairment') }}" autofocus> 
		                    </div>
		                    <div class="form-group {{ $errors->has('pemeriksaan_spesifik') ? ' has-error' : '' }}"> 
		                        ...
		                        <input id="pemeriksaan_spesifik" type="text" class="form-control" name="pemeriksaan_spesifik" value="{{ old('pemeriksaan_spesifik') }}" autofocus> 
		                    </div>
		                    <div class="form-group {{ $errors->has('problem_fisioterapi') ? ' has-error' : '' }}"> 
		                        ...
		                        <input id="problem_fisioterapi" type="text" class="form-control" name="problem_fisioterapi" value="{{ old('problem_fisioterapi') }}" autofocus> 
		                    </div>
		                    <div class="form-group {{ $errors->has('activity_limitations') ? ' has-error' : '' }}"> 
		                        ...
		                        <input id="activity_limitations" type="text" class="form-control" name="activity_limitations" value="{{ old('activity_limitations') }}" autofocus> 
		                    </div>
		                    <div class="form-group {{ $errors->has('participation_restriction') ? ' has-error' : '' }}"> 
		                       ...
		                       <input id="participation_restriction" type="text" class="form-control" name="participation_restriction" value="{{ old('participation_restriction') }}" autofocus> 
		                    </div>
              			...
              			<div class="col-md-6">
              				<div class="form-group{{ $errors->has('diagnosa_fisioterapi') ? ' has-error' : '' }}"> 
		                       ...
		                       <input type="text" class="form-control" name="diagnosa_fisioterapi" id="diagnosa_fisioterapi" placeholder="Cari ICD-10">
		                    </div>
              				<div class="form-group{{ $errors->has('evaluasi') ? ' has-error' : '' }}"> 
		                        <label for="name" class="control-label">Evaluasi</label>
		                        <textarea class="form-control" rows="5" cols="4" name="evaluasi"></textarea>
		                    </div>
		                    <div class="form-group{{ $errors->has('pelayanan_fisioterapi') ? ' has-error' : '' }}"> 
		                        ...
		                        <select class="form-control" name="pelayanan_fisioterapi">
		                        	...
		                        	@foreach($pelayanan as $data_pelayanans)
		                        		<option value="{{ $data_pelayanans['id_pelayanan'] }}">{{ $data_pelayanans['nama_pelayanan'] }} (Rp.{{ number_format($data_pelayanans['tarif_pelayanan']) }})</option>
		                        	@endforeach
		                        </select>
		                    </div>
		                    <div class="form-group{{ $errors->has('petugas_fisioterapi') ? ' has-error' : '' }}"> 
		                        ...
		                        <select class="form-control" name="petugas_fisioterapi" required="request">
		                        	...
		                        	@foreach($fisioterapis as $data_petugas)
		                        		<option value="{{ $data_petugas['id_fisioterapi'] }}">{{ $data_petugas['nama'] }}</option>
		                        	@endforeach
		                        </select>
		                    </div>
		                    <div class="form-group{{ $errors->has('catatan_khusus') ? ' has-error' : '' }}"> 
		                        <label for="name" class="control-label">Catatan Khusus</label>
		                        <textarea class="form-control" rows="5" cols="4" name="catatan_khusus"></textarea>
		                    </div>
              			</div>
              		</div>
