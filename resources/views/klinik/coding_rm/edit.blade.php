...
<div class="col-lg-12 col-md-12 lf_topics_wrapper"> 
  <h3>Rekam Medis | Proses Rekam Medis</h3>
	<div class="row"> 
		<div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="card card-stats">
              	<form class="form-horizontal" role="form" method="POST" action="{{ url('coding_rm/edit_register') }}">
                        {{ csrf_field() }} 
	              	<div class="card-body "> 
	                    ...
	                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
	                        ...
	                        <div class="col-md-6">
	                            ...
	                            <input id="jaminan" type="text" class="form-control" name="jaminan" value="{{ ($pasien_arr->no_bpjs !='')? $pasien_arr->jaminan.' ('.$pasien_arr->no_bpjs.')' : $pasien_arr->jaminan }}" autofocus readonly="readonly"> 
	                        </div> 
	                    </div>
	                    <hr>
	                    <div class="form-group">
	                    	<div class="col-md-12">
			                    ...
			                    <div class="form-group{{ $errors->has('diagnosa') ? ' has-error' : '' }}"> 
			                        <label for="name" class="control-label">Pemeriksaan Penunjang</label>
			                       <input type="text" class="form-control" name="pmr_penunjang" id="pmr_penunjang" placeholder="Pemeriksaan Penunjang" value="{{ old('pmr_penunjang', $pemeriksaan->pmr_penunjang) }}" {{ ($show_detail == true)? 'readonly="readonly"' : ''}}>
			                    </div>
			                    ...
			                    <div class="form-group{{ $errors->has('diagnosa') ? ' has-error' : '' }}"> 
			                       <label for="name" class="control-label">ICD 10</label>
			                       <span class="loadingIcd10"></span>
			                       <input type="text" class="form-control" name="icd10" id="icd10" placeholder="Cari ICD 10" value="{{ (!empty($pemeriksaan->kode_penyakit))? old('icd10', $pemeriksaan->kode_penyakit.' | '.$pemeriksaan->nama_penyakit) : '' }}" required="request">
			                    </div>  
	              			</div>
	              			<div class="col-md-6">
...
<script type="text/javascript">
	...
	$(document).on('keyup', '#icd10', function(){
 		$('#icd10').autocomplete({ 
	        source: function(request, response) { 
	        	var pathICD10 = "{{ url('coding_rm/searchICD10') }}";
	            
	            $('.loadingIcd10').html('Loading..........');
