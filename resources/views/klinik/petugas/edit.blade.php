	...
	<div class="row"> 
		<div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="card card-stats">
              	<form class="form-horizontal" role="form" method="POST" action="{{ url('petugas/edit_register') }}">
                        {{ csrf_field() }}

                     <input id="id_user" type="hidden" class="form-control" name="id_user" value="{{old('id_user',$user->id)}}" required >

                     <input id="id_petugas" type="hidden" class="form-control" name="id_petugas" value="{{old('id_petugas',$row->id_petugas)}}" required >
