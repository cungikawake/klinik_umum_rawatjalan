...
@section('title', 'Edit Farmasi')

@section('content')
<div class="col-lg-12 col-md-12 lf_topics_wrapper"> 
  <h3>Master Data | Edit Farmasi</h3>
	<div class="row"> 
		<div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="card card-stats">
              	<form class="form-horizontal" role="form" method="POST" action="{{ url('farmasi/edit_register') }}">
                        {{ csrf_field() }}

                     <input id="id_user" type="hidden" class="form-control" name="id_user" value="{{old('id_user',$user->id)}}" required >

                     <input id="id_farmasi" type="hidden" class="form-control" name="id_farmasi" value="{{old('id_farmasi',$row->id_farmasi)}}" required >
